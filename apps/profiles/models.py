...
class Profile(TimeStampedUUIDModel):
    ...
    gender = models.CharField(verbose_name=_("Gender"), choices=Gender.choices,default=Gender.OTHER,
                              max_length=20)
    country = CountryField(verbose_name=_("Country"),max_length=180, default="SE",blank=False,null=False)
    city = models.CharField(verbose_name=_("City"), max_length=180,
                            default="Stockholm", blank=False,null=False)
    is_buyer = models.BooleanField(verbose_name=("Buyer"), default=False,
